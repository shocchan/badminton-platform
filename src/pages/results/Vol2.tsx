...
const t = {
  ja: {
    ...
    desc: '第2回川口・蕨バド交流杯ミックスダブルス夜の部（2026年6月25日）の試合結果・総当たりスコア表。',
    date: '2026年6月25日（水）川口市芝園公民館',
  ...
  zh: {
    ...
    desc: '第2届川口・蕨羽毛球交流杯混合双打夜场（2026年6月25日）比赛结果・循环赛成绩表。',
    date: '2026年6月25日（周三）川口市芝园公民馆',
