...
const faqs = [
  {
    ...
    items: [
      ...
      {
        // TODO: しょっちゃん要記入: 見学の可否が確定したら回答を「可能です」等に書き換える
        q: '見学だけでも参加できますか？',
        a: '見学をご希望の場合は、事前にお問い合わせフォームからご連絡ください。',
      },
    ],
  },
  {
  ...
  },
  {
    ...
    items: [
      ...
      {
        // TODO: しょっちゃん要記入: 毎回の参加人数（「毎回◯名前後が参加しています」）を追記する
        q: 'どんな雰囲気ですか？何人くらい集まりますか？',
        a: '交流を大切にした和やかな雰囲気です。試合だけでなく、バドミントン仲間づくりの場としても好評です。',
      },
    ],
  },
  {
    ...
    items: [
      {
        q: '参加費はいつ支払うのですか？',
        a: '事前支払いが必要な大会と、当日支払いの大会があります。事前支払いはPayPayでの事前決済に対応しており、当日の精算が不要でスムーズに入場できます。大会カードの「事前支払い」表示をご確認ください。',
      },
      {
        q: 'キャンセルした場合、返金されますか？',
...
const faqsZh = [
  {
    ...
    items: [
      ...
      { q: '女生一个人参加也没问题吗？', a: '没问题。很多女生都是一个人参加的，主办方会全程照应，请放心参加。' },
      { q: '提供中文服务吗？', a: '提供中文咨询和当天中文支持。我们也在微信・小红书上发布信息，有很多中文参加者。' },
      // TODO: しょっちゃん要記入: 見学の可否が確定したら中文も書き換える
      { q: '可以只参观不参赛吗？', a: '希望参观的话，请提前通过咨询表单联系我们。' },
    ],
  },
  {
    category: '羽毛球及用具',
  ...
  },
  {
    ...
    items: [
      ...
      // TODO: しょっちゃん要記入: 参加人数が確定したら中文にも追記する
      { q: '现场氛围如何？大概多少人参加？', a: '氛围轻松友好，重视交流。除了比赛，作为结识球友的场合也很受欢迎。' },
    ],
  },
  {
    category: '费用及取消相关',
    icon: '💰',
    items: [
      { q: '参赛费用何时支付？', a: '部分赛事需要提前支付，部分可当天支付。提前支付支持PayPay，当天无需现场结算，入场更顺畅。请查看赛事卡上的"提前支付"说明。' },
