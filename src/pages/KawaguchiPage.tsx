 ...
 *
 * 【ただし実態は入会制サークルではない（2026-08-29 追記）】
 * 検索語を受けるために「サークル」と書く以上、**入会制だと誤解させない責任がある。**
 * 会員登録も継続の約束も無く、参加したい回ごとに申し込む形。
 * そのことを h1 の直下・description・FAQ・facts の4か所で明示する。
 * SEOのために語を残すが、**実態の正確さを優先する。**
 *
 * 【書いてよいこと】
...
const COPY = {
  ja: {
    ...
    description: '埼玉県川口市でバドミントンサークルを探している方へ。芝園公民館（川口市芝園町3-15）を中心に平日夜19:00〜21:00で活動。入会制ではなく1回ごとの申し込みで、超初級〜オープンの4クラス、参加費600円〜です。',
    breadcrumbHome: 'ホーム',
    ...
    noticeHeading: 'いわゆる「入会制のサークル」ではありません',
    noticeBody: '会員登録や、続けて通う約束はありません。参加したい回ごとに、そのページからオンラインで申し込みます。「バドミントンサークル」で探している方に向けてこの言葉を使っていますが、実態は1回ごとに参加できる交流会です。',

    venueHeading: '川口市の会場：芝園公民館',
    venueLead: '川口市内での活動は、芝園団地内にある芝園公民館が中心です。通常活動と大会（交流杯）のどちらもここで開催しています。',
    venueFacts: [
      { label: '住所', value: '埼玉県川口市芝園町3-15' },
      { label: 'アクセス', value: 'JR京浜東北線「蕨駅」西口から徒歩約10分（約770m）。芝園団地内にあります。' },
      { label: '駐車場', value: '館内駐車場は台数に限りがあります。満車時は隣接の川口芝園ショッピングモール駐車場（徒歩約1分）などのコインパーキングをご利用ください。' },
      { label: '使い方', value: '通常活動・大会（交流杯）ともに開催' },
      { label: '参加のしかた', value: '入会手続き・会員登録はありません。参加したい回ごとにオンラインで申し込みます。' },
    ],
    ...
    faq: [
      { question: '川口市のどこで活動していますか？', answer: '芝園公民館（埼玉県川口市芝園町3-15）が中心です。JR京浜東北線「蕨駅」西口から徒歩約10分（約770m）、芝園団地内にあります。隣の蕨市にある蕨市民体育館（蕨市北町1-27-15）でも活動しています。' },
  ...
  zh: {
    ...
    description: '在埼玉县川口市寻找羽毛球社团的朋友。以芝园公民馆（川口市芝园町3-15）为中心，平日夜间19:00〜21:00活动。不是入会制，按次报名即可。分超初级〜公开组4个级别，参加费600日元起。',
    breadcrumbHome: '首页',
    breadcrumb: '川口市的羽毛球社团',
    h1: '在川口市寻找羽毛球社团的朋友',
    lead: 'kawabado（川口・蕨羽毛球交流会）以川口市的芝园公民馆为中心，在平日夜间活动。按次报名，有空的时候来就好。',

    noticeHeading: '这里不是一般意义上的「入会制社团」',
    noticeBody: '没有会员登记，也不需要承诺长期参加。想参加哪一场，就在那一场的页面上单独报名。为了让用「羽毛球社团」搜索的人能找到我们，页面上使用了这个词，但实际上是可以按次参加的交流会。',

    venueHeading: '川口市的会场：芝园公民馆',
    venueLead: '在川口市内的活动以芝园团地内的芝园公民馆为中心。日常活动和大会（交流杯）都在这里举办。',
    venueFacts: [
      { label: '地址', value: '埼玉县川口市芝园町3-15' },
      { label: '交通', value: 'JR京滨东北线「蕨站」西口步行约10分钟（约770米）。位于芝园团地内。' },
      { label: '停车场', value: '馆内停车位数量有限。停满时请利用附近的川口芝园购物中心停车场（步行约1分钟）等收费停车场。' },
      { label: '用途', value: '日常活动・大会（交流杯）均在此举办' },
      { label: '参加方式', value: '没有入会手续和会员登记。想参加哪一场就单独报名。' },
    ],
    ...
    faq: [
      { question: '在川口市的什么地方活动？', answer: '以芝园公民馆（埼玉县川口市芝园町3-15）为中心。JR京滨东北线「蕨站」西口步行约10分钟（约770米），位于芝园团地内。在隔壁蕨市的蕨市民体育馆（蕨市北町1-27-15）也有活动。' },
  ...
  return (
    <>
      ...
      <main className="max-w-3xl mx-auto px-4 py-8 sm:py-12">
        ...
        {/* 検索語として「サークル」を受けている以上、入会制だと誤解させないことを
            h1 の直下（一番読まれる位置）で明示する。SEOより実態の正確さを優先する */}
        <section aria-labelledby="notice" className="mb-12 rounded-2xl border border-gray-300 bg-gray-50 p-5 sm:p-6">
          <h2 id="notice" className="text-base font-bold text-gray-900 mb-2">{t.noticeHeading}</h2>
          <p className="text-sm text-gray-600 leading-relaxed">{t.noticeBody}</p>
        </section>
