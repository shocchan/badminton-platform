...
const rules = [
  ...
  },
  {
    ...
    items: [
      {
        heading: 'シャトルは持参制です',
        body: '当大会はシャトル持参制を採用しています。ご自身でシャトルをご用意の上、ご参加ください。使用するシャトルは公式の羽（ナイロン・羽毛どちらも可）であれば問題ありません。',
        level: 'info',
      },
      {
        heading: '忘れた場合・持ち込めない場合は現地購入できます',
        body: '当日シャトルを忘れた場合、または持ち込みが難しい場合は、会場にて1球500円でご購入いただけます。ただし数に限りがあるため、なるべくご持参ください。',
        level: 'warning',
      },
    ],
  },
