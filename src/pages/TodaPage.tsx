 ...
 * **電車の経路・乗り換え駅・乗車時間・本数は書かない**（2026-08-29 に断定を撤回）。
 * サイト上に出典が無いうえ、ダイヤ改正や運休で古くなっても誰も気づけない。
 * 正確な経路案内は乗換案内・地図サービスに委ね、こちらは「電車でも来られる」事実と、
 * 蕨駅から先の徒歩分数（実測値）だけを出す。
...
const COPY = {
  ja: {
    title: '戸田のバドミントン | 蕨駅から徒歩圏の会場で平日夜に活動',
    ...
    lead: 'カワバド（川口・蕨バドミントン交流会）が使っている2会場は、戸田市に隣接する蕨市・川口市にあります。戸田市内での開催ではありませんが、戸田・戸田公園方面からも電車・自転車・自動車で来ていただけます。',

    accessHeading: '戸田駅・戸田公園駅からのアクセス',
    accessLead: '会場の最寄り駅はJR京浜東北線「蕨駅」です。戸田・戸田公園方面からも電車で来られます。経路と所要時間は時間帯によって変わるため、乗換案内でご確認ください。',
    accessFacts: [
      { label: '電車', value: '会場の最寄りはJR京浜東北線「蕨駅」です。戸田・戸田公園方面からも電車で来られます。経路・乗り換え・所要時間は、乗換案内アプリや地図サービスでご確認ください。' },
      { label: '蕨駅から会場まで（1）', value: '芝園公民館（埼玉県川口市芝園町3-15）まで、蕨駅西口から徒歩約10分（約770m）。芝園団地内にあります。' },
    ...
    faq: [
      ...
      { question: '戸田駅・戸田公園駅からどうやって行きますか？', answer: '会場の最寄り駅はJR京浜東北線「蕨駅」です。戸田・戸田公園方面からも電車で来られますが、経路と所要時間は時間帯で変わるため乗換案内でご確認ください。蕨駅から先は、芝園公民館まで徒歩約10分（約770m）、蕨市民体育館まで徒歩約14分です。' },
  ...
  zh: {
    ...
    lead: 'kawabado（川口・蕨羽毛球交流会）使用的2个会场位于与户田市相邻的蕨市・川口市。虽然不在户田市内举办，但从户田・户田公园方面可以坐电车、骑车或开车过来。',

    accessHeading: '从户田站・户田公园站的交通方式',
    accessLead: '会场最近的车站是JR京滨东北线「蕨站」。从户田・户田公园方面也可以坐电车过来。具体路线、换乘和所需时间请用换乘查询或地图服务确认。',
    accessFacts: [
      { label: '电车', value: '会场最近的车站是JR京滨东北线「蕨站」。从户田・户田公园方面也可以坐电车过来。具体路线、换乘和所需时间请用换乘查询或地图服务确认。' },
      { label: '从蕨站到会场（1）', value: '到芝园公民馆（埼玉县川口市芝园町3-15），从蕨站西口步行约10分钟（约770米）。位于芝园团地内。' },
    ...
    faq: [
      ...
      { question: '从户田站・户田公园站怎么去？', answer: '会场最近的车站是JR京滨东北线「蕨站」。从户田・户田公园方面也可以坐电车过来，但路线和所需时间因时段而异，请用换乘查询确认。从蕨站出发，到芝园公民馆步行约10分钟（约770米），到蕨市民体育馆步行约14分钟。' },
