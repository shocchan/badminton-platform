...
const faqsJa: FaqItem[] = [
  ...
  { question: 'シャトルは持参が必要ですか？', answer: '大会はシャトル持参制です（超初級ダブルス大会を除く）。通常活動はシャトル代が会費に含まれるため持参は不要です。ラケットと室内シューズはどちらも共通でご持参ください。' },
...
const faqsZh: FaqItem[] = [
  ...
  { question: '需要自带羽毛球吗？', answer: '比赛需自带羽毛球（超初级双打比赛除外）。常规活动的羽毛球费用已包含在活动费中，无需自带。球拍和室内运动鞋两者都请自带。' },
