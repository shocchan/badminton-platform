...
const TXT = {
  ja: {
    ...
    qs: [
      ...
      { k: 'scene', label: 'よく使う場面は？', opts: [['daily', '日常生活'], ['work', '仕事'], ['badminton', 'バドミントン'], ['interview', '面接・発表'], ['friends', '友人との交流']] },
  ...
  zh: {
    ...
    qs: [
      ...
      { k: 'scene', label: '常用的场合？', opts: [['daily', '日常生活'], ['work', '工作'], ['badminton', '羽毛球'], ['interview', '面试・发表'], ['friends', '朋友交流']] },
