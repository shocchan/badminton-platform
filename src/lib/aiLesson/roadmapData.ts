...
export const N2_ROADMAP: GoalRoadmap = {
  ...
  domains: [
    { key: 'vocab', totalItems: 800 },
    { key: 'kanji', totalItems: 400 },
    { key: 'grammar', totalItems: 120 },
    { key: 'reading', totalItems: 60 },
    { key: 'listening', totalItems: 80 },
    { key: 'conversation', totalItems: 100 },
    { key: 'mockExam', totalItems: 40 },
    { key: 'review', totalItems: 60 },
  ],
...
export const DAILY_ROADMAP: GoalRoadmap = {
  ...
  domains: [
    { key: 'conversation', totalItems: 100 },
    { key: 'vocab', totalItems: 300 },
    { key: 'grammar', totalItems: 60 },
    { key: 'listening', totalItems: 40 },
    { key: 'review', totalItems: 30 },
  ],
