...
export const CAN_DO_BY_CATEGORY: Record<MissionCategory, { ja: string; zh: string }> = {
  ...
  // 上級（N2〜N1）。2026-08-23 追加
  keigo: { ja: '尊敬語と謙譲語を場面で使い分けられる', zh: '能按场合区分使用尊敬语和谦让语' },
  debate: { ja: '相手を認めたうえで反論できる', zh: '能在认同对方的基础上提出反驳' },
  abstract: { ja: '抽象的な話を相手に分かる形で説明できる', zh: '能把抽象的话讲到对方能懂' },
  nuance: { ja: '角を立てずに断ったり頼んだりできる', zh: '能不伤和气地拒绝或请求' },
  business: { ja: '仕事を前に進める話し方ができる', zh: '能用推动工作的方式说话' },
  advanced: { ja: '立場や経緯を整理して、合意まで話を運べる', zh: '能梳理立场和来龙去脉，把话谈到达成一致' },
};
