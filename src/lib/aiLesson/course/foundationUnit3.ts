...
export const UNIT3_QUESTIONS: FoundationQuestion[] = [
  ...
  { id: 'f3q-r2', targetItemId: 'fi-hanasu', dimension: 'reading', type: 'reading_choice', promptJa: '「話して」の読みは？', promptZh: '「話して」怎么读？', choices: ['はなして', 'はなしって', 'ばなして'], answerIndex: 0, explanationJa: '話して＝はなして（す→して、小さい「っ」は入りません）。', explanationZh: '話して读作「はなして」（す→して，没有促音「っ」）。', errorTag: 'reading_hanashite', review: 'draft' },
  // 意味×2
  ...
  { id: 'f3q-f1', targetRuleId: 'fr-te-g1a', dimension: 'form', type: 'conjugation_choice', promptJa: '「買う」のて形は？', promptZh: '「買う」的て形是？', choices: ['買って', '買いて', '買うて', '買んで'], answerIndex: 0, explanationJa: 'う・つ・る→って。買う→買って。', explanationZh: 'う・つ・る结尾→って：買う→買って。', errorTag: 'te_katte', review: 'draft' },
  { id: 'f3q-f2', targetRuleId: 'fr-te-g1a', dimension: 'form', type: 'conjugation_choice', promptJa: '「読む」のて形は？', promptZh: '「読む」的て形是？', choices: ['読んで', '読って', '読みて'], answerIndex: 0, explanationJa: 'む・ぶ・ぬ→んで。読む→読んで。', explanationZh: 'む・ぶ・ぬ结尾→んで：読む→読んで。', errorTag: 'te_yonde', review: 'draft' },
  ...
  { id: 'f3q-f4', targetRuleId: 'fr-te-g2g3', dimension: 'form', type: 'conjugation_choice', promptJa: '「来る」のて形は？', promptZh: '「来る」的て形是？', choices: ['来て（きて）', '来て（くて）', '来って', '来るて'], answerIndex: 0, hintJa: '三類は読み方も変わります。', hintZh: '三类动词读音也会变化。', explanationJa: '来る→来て。読みは「きて」に変わります（×くて）。', explanationZh: '来る→来て，读音变为「きて」（不是くて）。', errorTag: 'te_kite', review: 'draft' },
  { id: 'f3q-f5', targetRuleId: 'fr-te-iku-exception', dimension: 'form', type: 'conjugation_choice', promptJa: '「行く」のて形は？', promptZh: '「行く」的て形是？', choices: ['行って', '行いて', '行きて'], answerIndex: 0, explanationJa: '例外：行く→行って（×行いて）。', explanationZh: '例外：行く→行って（不是「行いて」）。', errorTag: 'te_iku_exception', review: 'draft' },
  // 接続×1（てください接続）
  { id: 'f3q-c1', targetRuleId: 'fr-te-kudasai', dimension: 'connection', type: 'conjugation_choice', promptJa: '「ここに名前を＿＿ください」。正しいのは？', promptZh: '「ここに名前を＿＿ください」应该选？', choices: ['書いて', '書きて', '書き'], answerIndex: 0, explanationJa: 'ください」の前はて形。書く→書いて。', explanationZh: '「ください」前面用て形：書く→書いて。', errorTag: 'te_kudasai_connect', review: 'draft' },
  // 文中使用×2
