...
export const VOCAB_NEW_ITEMS: FoundationItem[] = [
  ...
  { id: 'fi-tsukau', lemma: '使う', displayForm: '使う', readingKana: 'つかう', readingRomaji: 'tsukau', partOfSpeech: 'verb', verbGroup: 'g1', coreLevel: 'A', imageAssetId: 'va-verb-tsukau-scene', meaningZh: '使用', exampleJa: 'スマホを使います。', exampleZh: '我用手机。', sources: [xls(MIN, 185, 'C185', '語彙行「使う」'), xls(KATSUYO, 47, 'B47', '活用表「使う」')], review: 'draft' },
  { id: 'fi-tsukuru', lemma: '作る', displayForm: '作る', readingKana: 'つくる', readingRomaji: 'tsukuru', partOfSpeech: 'verb', verbGroup: 'g1', coreLevel: 'A', imageAssetId: 'va-verb-tsukuru-scene', meaningZh: '做；制作', exampleJa: '晩ごはんを作ります。', exampleZh: '我做晚饭。', sources: [xls(MIN, 186, 'C186', '語彙行「作る」'), xls(KATSUYO, 48, 'B48', '活用表「作る」')], review: 'draft' },
  ...
  { id: 'fi-hairu', lemma: '入る', displayForm: '入る', readingKana: 'はいる', readingRomaji: 'hairu', partOfSpeech: 'verb', verbGroup: 'g1', coreLevel: 'A', imageAssetId: 'va-verb-hairu-scene', meaningZh: '进入', exampleJa: '店に入ります。', exampleZh: '我进店里。', usageNoteZh: '虽然以「る」结尾，但是一类动词：入ります・入って。', sources: [xls(MIN, 191, 'C191', '語彙行「入る」'), xls(KATSUYO, 53, 'B53', '活用表「入る」')], review: 'draft' },
  ...
  // ── い形容詞（16語・反対語ペア・§9） ──
  { id: 'fi-ookii', lemma: '大きい', displayForm: '大きい', readingKana: 'おおきい', readingRomaji: 'ookii', partOfSpeech: 'iAdj', coreLevel: 'A', antonymId: 'fi-chiisai', imageAssetId: 'va-adj-ookii-chiisai-contrast', meaningZh: '大', exampleJa: '大きいかばんです。', exampleZh: '是一个大包。', sources: [xls(MIN, 219, 'C219', '語彙行「大きい」')], review: 'draft' },
  { id: 'fi-chiisai', lemma: '小さい', displayForm: '小さい', readingKana: 'ちいさい', readingRomaji: 'chiisai', partOfSpeech: 'iAdj', coreLevel: 'A', antonymId: 'fi-ookii', imageAssetId: 'va-adj-ookii-chiisai-contrast', meaningZh: '小', exampleJa: '小さい店です。', exampleZh: '是一家小店。', sources: [xls(MIN, 220, 'C220', '語彙行「小さい」')], review: 'draft' },
  ...
  { id: 'fi-yasui', lemma: '安い', displayForm: '安い', readingKana: 'やすい', readingRomaji: 'yasui', partOfSpeech: 'iAdj', coreLevel: 'A', antonymId: 'fi-takai', imageAssetId: 'va-adj-takai-yasui-contrast', meaningZh: '便宜', exampleJa: '安いスーパーで買います。', exampleZh: '我在便宜的超市买东西。', sources: [xls(MIN, 223, 'C223', '語彙行「安い」')], review: 'draft' },
  ...
  { id: 'fi-jouzu', lemma: '上手', displayForm: '上手', readingKana: 'じょうず', readingRomaji: 'jouzu', partOfSpeech: 'naAdj', coreLevel: 'A', meaningZh: '擅长', exampleJa: '料理が上手です。', exampleZh: '他很会做菜。', usageNoteZh: '对象用「が」。夸自己一般不用「上手」。', sources: [ext(extNote)], review: 'draft' },
  // ── 名詞・場面（12語・§10） ──
