...
export const UNIT2_QUESTIONS: FoundationQuestion[] = [
  ...
  { id: 'f2q-r2', targetItemId: 'fi-kaeru', dimension: 'reading', type: 'kana_input', promptJa: '「帰る」の読みをひらがなで入力してください。', promptZh: '请用平假名输入「帰る」的读音。', accepted: ['かえる'], explanationJa: '帰る＝かえる。', explanationZh: '帰る读作「かえる」。', errorTag: 'reading_kaeru', review: 'draft' },
  // 意味×3
  ...
  { id: 'f2q-f1', targetRuleId: 'fr-verb-groups', dimension: 'form', type: 'single_choice', promptJa: '「帰る」はどのグループ？', promptZh: '「帰る」属于哪一类动词？', choices: ['一類', '二類', '三類'], answerIndex: 0, hintJa: '「る」で終わっても一類の動詞があります。', hintZh: '有些以「る」结尾的动词其实是一类。', explanationJa: '帰るは「る」で終わりますが一類（帰ります・帰らない）。', explanationZh: '「帰る」虽以る结尾但是一类动词（帰ります・帰らない）。', errorTag: 'group_kaeru_exception', review: 'draft' },
  { id: 'f2q-f2', targetRuleId: 'fr-masu-form', dimension: 'form', type: 'conjugation_input', promptJa: '「行く」のます形は？（〜ます の形で入力）', promptZh: '「行く」的ます形是？（请输入〜ます的形式）', accepted: ['行きます', 'いきます'], explanationJa: '一類：うの音→いの音＋ます。行く→行きます。', explanationZh: '一类动词u音变i音＋ます：行く→行きます。', errorTag: 'masu_iku', review: 'draft' },
  { id: 'f2q-f3', targetRuleId: 'fr-masu-form', dimension: 'form', type: 'single_choice', promptJa: '「食べる」のます形は？', promptZh: '「食べる」的ます形是？', choices: ['食べます', '食べります', '食べします'], answerIndex: 0, explanationJa: '二類：る→ます。食べる→食べます。', explanationZh: '二类动词去る＋ます：食べる→食べます。', errorTag: 'masu_taberu', review: 'draft' },
  { id: 'f2q-f4', targetRuleId: 'fr-nai-form', dimension: 'form', type: 'single_choice', promptJa: '「来る」のない形は？', promptZh: '「来る」的ない形是？', choices: ['来ない（こない）', '来らない', '来ない（くない）'], answerIndex: 0, explanationJa: '三類の例外：来る→来ない（こない）。読みも変わります。', explanationZh: '三类动词特殊变化：来る→来ない，读音变为「こない」。', errorTag: 'nai_kuru_exception', review: 'draft' },
  { id: 'f2q-f5', targetRuleId: 'fr-nai-form', dimension: 'form', type: 'conjugation_input', promptJa: '「買う」のない形は？', promptZh: '「買う」的ない形是？', accepted: ['買わない', 'かわない'], hintJa: '「う」で終わる動詞は「わ」になります。', hintZh: '以「う」结尾的动词变「わ」。', explanationJa: '買う→買わない（×買あない）。うで終わる一類は「わ＋ない」。', explanationZh: '買う→買わない（不是「買あない」）。以う结尾的一类动词变「わ＋ない」。', errorTag: 'nai_kau_wa', review: 'draft' },
  // 接続×1（ある→ない例外）
  { id: 'f2q-c1', targetRuleId: 'fr-nai-form', dimension: 'connection', type: 'single_choice', promptJa: '「時間が＿＿」。「ない」を使った正しい形は？', promptZh: '「時間が＿＿」。用否定的正确说法是？', choices: ['ありません', 'あらないです', 'ないます'], answerIndex: 0, explanationJa: '「ある」の否定は例外：ていねい形は「ありません」、ふつう形は「ない」。「あらない」とは言いません。', explanationZh: '「ある」的否定是例外：礼貌体「ありません」，普通体「ない」。没有「あらない」这种说法。', errorTag: 'nai_aru_exception', review: 'draft' },
  // 文中使用×2
