...
export const PLACE_NAME: Record<number, { ja: string; zh: string }> = {
  ...
  // 上級（第13〜18週・2026-08-23）。N2帯以上の人はここから旅が始まる
  // （courseEngine.conversationEntryWeekOf）。地図に無いと「現在地」が第1週に固定され、
  // 出ている会話と地図が食い違う
  13: { ja: '敬語の城', zh: '敬语之城' },
  14: { ja: '議論の橋', zh: '辩论之桥' },
  15: { ja: '説明の塔', zh: '说明之塔' },
  16: { ja: '配慮の庭', zh: '分寸之庭' },
  17: { ja: '仕事の街', zh: '工作之街' },
  18: { ja: '上級会話の峰', zh: '高级会话之峰' },
};

/** 会話カリキュラムの最終週（第12週で止めると上級パートへ週が進まない） */
export const LAST_CONVERSATION_WEEK = 18;
