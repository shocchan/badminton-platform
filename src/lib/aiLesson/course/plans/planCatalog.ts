...
export const PLAN_CATALOG: PlanConfig[] = [
  {
    ...
    priceJpy: 600,
    descriptionJa: '開始から60分間、教材と冒険は使い放題。AI先生との音声会話レッスンも3回できます。買い切りで、自動更新はありません。',
    descriptionZh: '开始后的60分钟内，教材与冒险随意使用。还可以上3次AI老师的语音会话课。一次性付费，不会自动续费。',
    ...
    autoRenew: false,
    featuresJa: [
      '開始から60分間、教材・冒険・文法バトルが使い放題',
      '冒険マップの最初の3地域まで攻略し放題',
      'AI先生との音声会話レッスン 3回（1回最大4分）',
      '会話後のAIフィードバック',
      '好きなタイミングで開始できる（購入後30日以内）・自動更新なし',
    ],
    featuresZh: [
      '开始后的60分钟内，教材・冒险・语法战斗随意使用',
      '冒险地图最初的3个区域随意攻略',
      'AI老师的语音会话课 3次（每次最长4分钟）',
      '会话后的AI反馈',
  ...
  },
  {
    ...
    audienceJa: '毎日つかえる教材で、1か月自分のペースで自学したい人',
    audienceZh: '想用每天都能用的教材、按自己节奏自学1个月的人',
