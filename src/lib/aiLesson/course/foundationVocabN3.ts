...
export const N3_ITEMS: FoundationItem[] = [
  ...
  v('fi-tsuzukeru', '続ける', 'つづける', 'tsuzukeru', 'verb', '（他）继续（做）', ['勉強を続ける', '運動を続けています'], '毎日少しずつ勉強を続けています。', '每天坚持学一点。', [xls(SAN, 18, 'D18', 'exact_lexeme', '3単語例文「続ける」')], undefined, 'g2'),
  v('fi-tsuzuku', '続く', 'つづく', 'tsuzuku', 'verb', '（自）持续', ['雨が続く', '忙しい日が続いています'], '暑い日が続いています。', '连日高温。', [xls(JIDO, 14, 'C14', 'exact_lexeme', '自動詞・他動詞46選「続く」')], undefined, 'g1'),
  ...
  v('fi-kanjiru', '感じる', 'かんじる', 'kanjiru', 'verb', '感觉到', ['成長を感じる', '不安を感じました'], '日本語の上達を感じています。', '感觉到日语在进步。', [ext()], undefined, 'g2'),
  v('fi-tsutaeru', '伝える', 'つたえる', 'tsutaeru', 'verb', '转达；传达', ['気持ちを伝える', '予定を伝えました'], '店の人に希望を伝えました。', '把要求告诉了店员。', [xls('原：ビジネス敬語', 12, 'A12', 'exact_lexeme', 'ビジネス敬語シート「伝える」')], undefined, 'g2'),
  ...
  v('fi-renraku', '連絡する', 'れんらくする', 'renraku suru', 'verb', '联系', ['会社に連絡する', '後で連絡します'], '遅れるときは連絡してください。', '要迟到时请联系。', [xls(SAN, 16, 'D16', 'exact_lexeme', '3単語例文「連絡する」')], undefined, 'g3'),
  ...
  v('fi-yoyaku', '予約する', 'よやくする', 'yoyaku suru', 'verb', '预约', ['店を予約する', '病院を予約しました'], 'レストランを予約しました。', '订了餐厅。', [xls(MIN, 213, 'C213', 'exact_lexeme', '語彙行「予約する」')], undefined, 'g3'),
  ...
  v('fi-shiraberu', '調べる', 'しらべる', 'shiraberu', 'verb', '查；调查', ['意味を調べる', 'ネットで調べました'], '分からない言葉を調べます。', '查不懂的词。', [ext()], undefined, 'g2'),
  ...
  v('fi-nareru', '慣れる', 'なれる', 'nareru', 'verb', '习惯', ['生活に慣れる', '仕事に慣れました'], '日本の生活にだいぶ慣れました。', '基本习惯了日本的生活。', [ext()], '对象用「に」：〜に慣れる。', 'g2'),
  v('fi-komaru', '困る', 'こまる', 'komaru', 'verb', '为难；困扰', ['返事に困る', 'お金に困っています'], '漢字が読めなくて困りました。', '因为不认识汉字很为难。', [xls(SAN, 13, 'E13', 'exact_lexeme', '3単語例文「困る」')], undefined, 'g1'),
  ...
  v('fi-yotei', '予定', 'よてい', 'yotei', 'noun', '预定；计划', ['予定がある', '予定を変える'], '週末は予定があります。', '周末有安排。', [xls(SAN, 19, 'C19', 'exact_lexeme', '3単語例文「予定」')]),
  v('fi-shuukan', '習慣', 'しゅうかん', 'shuukan', 'noun', '习惯', ['習慣にする', '毎朝の習慣'], '朝散歩するのが習慣です。', '早上散步是我的习惯。', [xls(SAN, 18, 'C18', 'exact_lexeme', '3単語例文「習慣」')]),
  v('fi-houhou', '方法', 'ほうほう', 'houhou', 'noun', '方法', ['いい方法', '方法を考える'], '覚える方法を変えました。', '换了记单词的方法。', [ext()]),
  ...
  v('fi-fukuzatsu', '複雑', 'ふくざつ', 'fukuzatsu', 'naAdj', '复杂', ['複雑な手続き', '気持ちが複雑'], '日本の電車は少し複雑です。', '日本的电车线路有点复杂。', [xls(SAN, 22, 'C22', 'exact_lexeme', '3単語例文「複雑」')]),
