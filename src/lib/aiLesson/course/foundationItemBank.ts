...
export const BANK_ITEMS: FoundationItem[] = [
  // --- 基本動詞（単元2・3・5で共有） ---
  { id: 'fi-iku', lemma: '行く', displayForm: '行く', readingKana: 'いく', readingRomaji: 'iku', partOfSpeech: 'verb', verbGroup: 'g1', meaningZh: '去', exampleJa: '学校に行きます。', exampleZh: '去学校。', usageNoteZh: '目的地用「に／へ」。て形是例外「行って」。', sources: verbRefs('行く', 173, 35, 107), review: 'draft' },
  ...
  { id: 'fi-suru', lemma: 'する', displayForm: 'する', readingKana: 'する', readingRomaji: 'suru', partOfSpeech: 'verb', verbGroup: 'g3', meaningZh: '做', exampleJa: '仕事をします。', exampleZh: '做工作。', usageNoteZh: '三类动词：します・しない・して。', sources: verbRefs('する', 172, 34, 106), review: 'draft' },
  { id: 'fi-taberu', lemma: '食べる', displayForm: '食べる', readingKana: 'たべる', readingRomaji: 'taberu', partOfSpeech: 'verb', verbGroup: 'g2', meaningZh: '吃', exampleJa: '朝ごはんを食べます。', exampleZh: '吃早饭。', sources: verbRefs('食べる', 181, 43, 115), review: 'draft' },
  { id: 'fi-miru', lemma: '見る', displayForm: '見る', readingKana: 'みる', readingRomaji: 'miru', partOfSpeech: 'verb', verbGroup: 'g2', meaningZh: '看', exampleJa: '映画を見ます。', exampleZh: '看电影。', sources: verbRefs('見る', 176, 38, 110), review: 'draft' },
  { id: 'fi-hanasu', lemma: '話す', displayForm: '話す', readingKana: 'はなす', readingRomaji: 'hanasu', partOfSpeech: 'verb', verbGroup: 'g1', meaningZh: '说', exampleJa: '日本語を話します。', exampleZh: '说日语。', sources: verbRefs('話す', 178, 40, 112), review: 'draft' },
  ...
  { id: 'fi-kaku', lemma: '書く', displayForm: '書く', readingKana: 'かく', readingRomaji: 'kaku', partOfSpeech: 'verb', verbGroup: 'g1', meaningZh: '写', exampleJa: '名前を書きます。', exampleZh: '写名字。', sources: [xls(MIN, 179, 'C179', 'exact_lexeme', '語彙行「書く」'), xls(KATSUYO, 5, 'G5', 'exact_lexeme', '活用表「書く」')], review: 'draft' },
  { id: 'fi-yomu', lemma: '読む', displayForm: '読む', readingKana: 'よむ', readingRomaji: 'yomu', partOfSpeech: 'verb', verbGroup: 'g1', meaningZh: '读', exampleJa: '本を読みます。', exampleZh: '读书。', sources: verbRefs('読む', 180, 42, 114), review: 'draft' },
  { id: 'fi-kau', lemma: '買う', displayForm: '買う', readingKana: 'かう', readingRomaji: 'kau', partOfSpeech: 'verb', verbGroup: 'g1', meaningZh: '买', exampleJa: '水を買います。', exampleZh: '买水。', usageNoteZh: 'ない形是「買わない」（不是「買あない」）。', sources: verbRefs('買う', 183, 45, 117), review: 'draft' },
  ...
  { id: 'fi-iru-exist', lemma: 'いる', displayForm: 'いる', readingKana: 'いる', readingRomaji: 'iru', partOfSpeech: 'verb', verbGroup: 'g2', meaningZh: '有；在（有生命）', exampleJa: '猫がいます。', exampleZh: '有猫。', usageNoteZh: '中文都是「有」，日语必须区分：人・动物→いる，物→ある。', sources: [ext('Excel内に「いる」単独の語彙セルなし。標準初級範囲（存在動詞）から補完')], review: 'draft' },
  { id: 'fi-neko', lemma: '猫', displayForm: '猫', readingKana: 'ねこ', readingRomaji: 'neko', partOfSpeech: 'noun', meaningZh: '猫', exampleJa: '猫がいます。', exampleZh: '有猫。', sources: [ext('Excel内に「猫」単独の語彙セルなし。標準初級範囲（身近な名詞）から補完')], review: 'draft' },
  // --- 単元5（に・で・へ） ---
  ...
  { id: 'fi-ikutsu', lemma: 'いくつ', displayForm: 'いくつ', readingKana: 'いくつ', readingRomaji: 'ikutsu', partOfSpeech: 'expression', meaningZh: '几个', exampleJa: 'いくつですか。', exampleZh: '要几个？', sources: [xls(MIN, 274, 'C274', 'exact_lexeme', '語彙行「いくつ」')], review: 'draft' },
