...
const IMPORTED: Record<string, { filePath: string; thumbnailPath: string; width: number; height: number }> = {
  ...
  'va-verb-noru-scene': { filePath: '/images/ai-course/foundation/verbs/verb-noru-scene-v1.webp', thumbnailPath: '/images/ai-course/foundation/verbs/verb-noru-scene-v1-thumb.webp', width: 800, height: 600 },
  'va-verb-oriru-scene': { filePath: '/images/ai-course/foundation/verbs/verb-oriru-scene-v1.webp', thumbnailPath: '/images/ai-course/foundation/verbs/verb-oriru-scene-v1-thumb.webp', width: 800, height: 600 },
  'va-verb-hairu-scene': { filePath: '/images/ai-course/foundation/verbs/verb-hairu-scene-v1.webp', thumbnailPath: '/images/ai-course/foundation/verbs/verb-hairu-scene-v1-thumb.webp', width: 800, height: 600 },
  'va-verb-deru-scene': { filePath: '/images/ai-course/foundation/verbs/verb-deru-scene-v1.webp', thumbnailPath: '/images/ai-course/foundation/verbs/verb-deru-scene-v1-thumb.webp', width: 800, height: 600 },
