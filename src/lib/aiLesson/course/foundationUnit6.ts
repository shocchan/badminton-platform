...
export const UNIT6_QUESTIONS: FoundationQuestion[] = [
  ...
  { id: 'f6q-r3', targetRuleId: 'fr-time-reading', dimension: 'reading', type: 'reading_choice', promptJa: '「9時」の読みは？', promptZh: '「9時」怎么读？', choices: ['くじ', 'きゅうじ', 'ここのじ'], answerIndex: 0, explanationJa: '9時＝くじ（×きゅうじ）。特殊読みです。', explanationZh: '9時读「くじ」（不是きゅうじ）。是特殊读法。', errorTag: 'reading_kuji', review: 'draft' },
  // 意味×2
  ...
  { id: 'f6q-f2', targetRuleId: 'fr-counters', dimension: 'form', type: 'reading_choice', promptJa: '「二人」の読みは？', promptZh: '「二人」怎么读？', choices: ['ふたり', 'ににん', 'にじん'], answerIndex: 0, explanationJa: '二人＝ふたり（三人からは「さんにん」）。', explanationZh: '二人＝ふたり（从三人起是さんにん）。', errorTag: 'form_futari', review: 'draft' },
  // 接続×1
  ...
  // 文中使用×3
  { id: 'f6q-u1', targetRuleId: 'fr-shopping', dimension: 'usage', type: 'sentence_choice', promptJa: 'りんごを3つ買いたいとき、店で何と言う？', promptZh: '想买3个苹果时，在店里怎么说？', choices: ['りんごを三つください。', 'りんごが三つです。', 'りんごを三つあります。'], answerIndex: 0, explanationJa: '数＋ください：りんごを三つください。', explanationZh: '数量＋ください：りんごを三つください。', errorTag: 'usage_kudasai_count', review: 'draft' },
  ...
  { id: 'f6q-u3', targetItemId: 'fi-ikura', dimension: 'usage', type: 'sentence_choice', promptJa: '値段を聞くとき、自然なのは？', promptZh: '询问价格时最自然的说法是？', choices: ['これはいくらですか。', 'これはいくつですか。', 'これは何時ですか。'], answerIndex: 0, explanationJa: '値段＝いくら。個数＝いくつ、時刻＝何時。', explanationZh: '价格用いくら；个数用いくつ；时刻用何時。', errorTag: 'usage_ikura_scene', review: 'draft' },
];
