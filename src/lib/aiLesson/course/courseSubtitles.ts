...
/** そのモードで、翔子先生の発話に中国語を「常時」自動表示するか */
...
/**
 * 「困ったときだけ」モードで、この翔子先生の発話に補助字幕を自動表示すべきか。
 * - 翔子先生が中国語で補助した
 * - 直前に生徒が「分からない」と言った
