...
export const SHUTTLE_MILESTONES: Milestone[] = [
  { count: 50, label: '50本達成', tier: 'small' },
  { count: 100, label: '100本達成', tier: 'small' },
  { count: 300, label: '300本達成', tier: 'big' },
  { count: 500, label: '500本達成', tier: 'big' },
  { count: 1000, label: '1000本突破', tier: 'big' },
];
