...
- 1つの発話（音声）の中に、日本語の文と中国語の文を混ぜない。必ず別々の発話に分ける。
- 日本語の例文・目標表現は、独立した日本語の発話として、日本語の発音で読む。
- 中国語の説明は、独立した中国語の発話として、中国語の発音で読む。
- 日本語の表現（漢字を含む）を中国語の文の中へ埋め込んで読み上げない。
  （例: ×「『疲れています』这句话表示…」のように1文に混ぜる／
    ○ まず日本語で「疲れています」と言い、区切ってから、別の発話で中国語の説明をする）
- 望ましい順序: ①日本語の例文（日本語音声）→ ②区切り → ③中国語の説明（中国語音声）→ ④必要なら再度、日本語の例文（日本語音声）。
